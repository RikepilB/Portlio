                ...
                <div className="relative border-l-2 border-[#F3F4F6] ml-3 sm:ml-0 md:pl-8 space-y-16">
                    {experiences.map((exp) => (
                        <article key={exp.id} className="relative pl-8 md:pl-0">
                            ...
                            <div
                                className="absolute -left-[41px] md:-left-[41px] w-6 h-6 bg-white border-4 border-[#F3F4F6] rounded-full flex items-center justify-center top-1"
                                aria-hidden
                            >
                            ...
                            <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-8 mb-4">
                                ...
                                <div>
                                    <h2 className="font-display text-2xl font-bold text-[#1A1A1A] mb-1">{exp.role}</h2>
                                    <p className="text-lg font-medium text-[#10B981]">{exp.org} <span className="text-[#6B7280] text-sm md:text-base font-normal">— {exp.location}</span></p>
                                </div>
                            </div>
