...
export const experiences: Experience[] = [
    {
        ...
        endDate: 'present',
        description:
            'Leading web content strategy and UX design for an EdTech platform, driving user engagement through Webflow and experience-centered design.',
        bullets: [
        ...
        skills: ['Webflow', 'UX Design', 'Content Strategy', 'Figma'],
        highlight: 'EdTech UX Lead',
    },
    {
        id: 'karac',
        type: 'work',
        ...
        endDate: '2025-12',
        description:
            'Internship building frontend features for a Swiss startup. Reduced user signup time from 2 minutes to 45 seconds through UX and performance improvements.',
        bullets: [
        ...
        skills: ['Laravel', 'Alpine.js', 'Tailwind CSS', 'JavaScript'],
        highlight: 'Signup time: 2 min → 45s',
    },
    {
        id: 'examvault-dev',
        type: 'work',
