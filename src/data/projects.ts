...
export const projects: Project[] = [
    ...
    },
    {
        ...
        stack: ['Python', 'Django REST Framework', 'PostgreSQL', 'React 19', 'Material UI', 'Nivo', 'Vite', 'Docker'],
    },
    {
        id: '5',
    ...
    },
    {
        ...
        inProgress: true,
        title: 'ScoutLane — Evidence-Led Recruitment Platform',
        tagline:
            'ScoutLane turns resumes into reviewable evidence and keeps every hiring decision connected to the candidate.',
        blurb: 'Evidence-led candidate records, AI resume parsing, Kanban pipelines, and production hiring infrastructure.',
        category: 'FULL STACK 2026',
        catColor: '#0c5a40',
        duration: 'Apr – Sep 2026',
        readTime: '7 min read',
        image: '/images/projects/scoutlane-home.png',
        images: ['/images/projects/scoutlane-home.png', '/images/scoutlane.png', '/images/foglamp/scoutlane.png'],
        demoVideo: 'https://scoutlane.net/',
    ...
    },
    {
        ...
        duration: 'Jun 2026',
        readTime: '7 min read',
        image: '/images/projects/el-umbral-home.png',
        images: ['/images/projects/el-umbral-home.png', '/images/elumbral.png'],
        demoVideo: 'https://elumbralvzla.org',
        github: 'https://github.com/RikepilB/build4venezuela-projecthub',
        stack: ['Next.js 16', 'React 19', 'TypeScript', 'Tailwind CSS 4', 'Zod', 'Fuse.js', 'Papa Parse', 'Vercel'],
        results: [
    ...
    },
    {
        ...
        status: 'shipped',
        inProgress: true,
        image: '/images/projects/findleads-home.png',
        images: ['/images/projects/findleads-home.png', '/images/projects/findleads-codebase-map.png', '/images/findleads-landing.png'],
        demoVideo: 'https://findleads-opal.vercel.app/',
        codebaseMapUrl: 'https://foglamp.dev/scan/findleads-amc6tw',
        ...
        blurb: 'A compact prospecting console for finding, filtering, tracking, and exporting local-business leads.',
        ...
        methodology: [
            ...
            {
                phase: 'Phase 3',
                title: 'Prospecting Console & Durable CRM State',
                detail:
        ...
        results: [
            { metric: '125', label: 'tests green after the latest database-clock and usability pass' },
            { metric: '400', label: 'business records used in the verified Neon-backed product review' },
            { metric: '60', label: 'maximum results per focused search run, made explicit in the UI' },
        ],
        keyFindings: [
        ...
        stack: ['Next.js 16.2', 'React 19', 'TypeScript', 'Neon Postgres', 'Drizzle ORM', 'Zod 4', 'SWR', 'Tailwind 4', 'Vitest 4'],
    },
    {
        id: '13',
        slug: 'peru-tech-map',
        ...
        images: ['/images/projects/peru-grid-home.png', '/images/peru-grid.png', '/images/foglamp/peru-tech-map.png'],
        ...
        stack: ['MapLibre GL JS', 'OpenFreeMap', 'Vanilla JS', 'Python', 'FormSubmit', 'GitHub Actions'],
    },
    {
        id: '14',
        slug: 'voidscape',
        ...
        status: 'shipped',
        inProgress: true,
        image: '/images/projects/voidscape-home.png',
        images: ['/images/projects/voidscape-home.png', '/images/voidscape.png', '/images/read-video.gif', '/images/foglamp/voidscape.png'],
        demoVideo: 'https://voidscape.club/',
        codebaseMapUrl: 'https://foglamp.dev/scan/voidscape-8fd1nx',
        title: 'Voidscape — Turning Personal Media into Citable Evidence',
        tagline:
            'Voidscape reads video, audio, images, articles, feeds, and chat exports through one visible sequence: inspect, preview, read.',
        blurb: 'Turns personal media into evidence an agent can cite — local-first, cost-aware, and explicit about consent.',
        ...
        methodology: [
            ...
            {
                phase: 'Phase 2',
                title: 'Evidence Bundles Across Media Types',
                detail:
            ...
            {
                phase: 'Phase 3',
                title: 'Agent-Native Recovery and Errors',
                detail:
                ...
                tech: ['Agent Protocols', 'JSON', 'PowerShell', 'Bash'],
            },
            {
                phase: 'Phase 4',
                title: 'Release Evidence and Hardening',
                detail:
                ...
                tech: ['pytest', 'GitHub Actions', 'Security Review', 'Browser QA'],
            },
        ],
        results: [
            { metric: '93.3%', label: 'eval assertions passed with the skill, vs 66.7% baseline without it' },
            { metric: '1,314', label: 'tests passed on Windows at the current merged checkpoint' },
            { metric: '0–6', label: 'deterministic exit-code range with retryability metadata' },
            { metric: '3', label: 'visible steps before evidence is consumed: inspect, preview, read' },
        ],
        keyFindings: [
        ...
        stack: ['Python', 'ffmpeg', 'yt-dlp', 'faster-whisper', 'pytest', 'uv', 'Codex'],
    },
    {
        id: '15',
        slug: 'resume-scorer',
