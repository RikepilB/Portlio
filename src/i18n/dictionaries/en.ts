export const dictionaryEn = {
  ...
  home: {
    ...
    location: 'Toronto, ON',
    kicker: 'Full-stack engineer · frontend & AI',
    lede: 'I build scalable products, AI-powered features, and robust systems from Toronto.',
    viewWork: 'View work',
  ...
  projects: {
    ...
    techStackAria: 'Project technology stack',
    projectLinksAria: 'Project links',
    details: 'Details',
    demo: 'Demo',
    code: 'Code',
