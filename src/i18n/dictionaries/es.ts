export const dictionaryEs = {
  ...
  home: {
    ...
    location: 'Toronto, ON',
    kicker: 'Ingeniero full-stack · frontend e IA',
    lede: 'Construyo productos escalables, funcionalidades con IA y sistemas robustos desde Toronto.',
    ...
    essaysKicker: 'Escritos',
    essaysTitle: 'Ensayos',
    viewAllEssays: 'Todos los ensayos',
  ...
  projects: {
    ...
    techStackAria: 'Tecnologías del proyecto',
    projectLinksAria: 'Enlaces del proyecto',
    details: 'Detalles',
    demo: 'Demo',
    code: 'Código',
    codebase: 'Mapa del codebase',
  ...
  resume: {
    ...
    certifications:
      'Certificaciones: Power BI Data Analyst (Microsoft), Scrum Master (Scrum.org), Claude Certified Architect (Anthropic). En curso: AWS AI Practitioner.',
  },
  about: {
    label: 'Sobre mí',
    heading: '¿Quién eres?',
