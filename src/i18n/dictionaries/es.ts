export const dictionaryEs = {
  ...
  about: {
    ...
    bio: [
      'Soy ingeniero full-stack con foco en frontend, construyendo interfaces escalables con React, Next.js y Node.js. He lanzado productos con IA y diseñado sistemas end-to-end, desde la idea hasta producción.',
      'He mejorado el onboarding de una plataforma para optimizar el registro, lideré un equipo de cinco personas para crear un sistema de gestión de estudiantes y desarrollé una app de reclutamiento con automatizaciones basadas en IA.',
      'Mis fortalezas son la comunicación clara, la autodidactía y el enfoque en el producto. Ante un reto, prefiero lanzar una versión pequeña, medir e iterar antes que sobreconstruir. Mi formación en economía me lleva a pensar en coste y retorno, y ahora profundizo en infraestructura de IA y rendimiento para seguir creciendo.',
    ],
    education: {
      degree: 'Lic. en Ciencias de la Computación',
      minor: 'Minor en Economía',
